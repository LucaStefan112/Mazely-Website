...
const icons = [
  ...
  // Multi-floor - layers
  <svg key="layers" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19.5 12c0-1.232-.046-2.453-.138-3.662a4.006 4.006 0 00-3.7-3.7 48.678 48.678 0 00-7.324 0 4.006 4.006 0 00-3.7 3.7c-.017.22-.032.441-.046.662M19.5 12l3-2m-3 2l-3-2m-12 0l3 2m-3-2l3-2m12 8c0 1.232-.046 2.453-.138 3.662a4.006 4.006 0 01-3.7 3.7 48.656 48.656 0 01-7.324 0 4.006 4.006 0 01-3.7-3.7c-.017-.22-.032-.441-.046-.662M4.5 12l3 2m-3-2l-3 2" /></svg>,
  // Smart routing - route
          ...
          {features.map((feature, i) => (
            ...
            >
              <div className="relative h-full p-7 rounded-2xl bg-white border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-primary-500/5 hover:border-primary-100 transition-all duration-300 hover:-translate-y-1">
                {/* Icon */}
                <div
                  className={`w-12 h-12 rounded-xl bg-gradient-to-br ${gradients[i]} text-white flex items-center justify-center shadow-lg mb-5`}
                >
                  {icons[i]}
                </div>
